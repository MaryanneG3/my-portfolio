              ...
              <div className="w-full flex flex-col items-start pl-2 pr-5 md:pr-0 lg:pr-0 lg:pl-5 gap-10">
                {sublinks?.map((link, index) => (
                  <div
                    ...
                    className="flex flex-col justify-start items-start gap-6 lg:gap-11 pl-0 md:pl-8 lg:pl-10 lg:pr-10 h-full w-full pb-20 pt-5 lg:pt-8 sm:bg-transparent md:bg-white/40 lg:bg-white/40 rounded-2xl lg:shadow-md"
                  >
