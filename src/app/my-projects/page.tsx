  ...
  return (
    <div className="h-full w-full">
      ...
      <div className="relative z-10 flex flex-col lg:flex-row justify-between items-center h-full w-full bg-white/20">
        ...
        <motion.div
          className="flex flex-col justify-center md:justify-center lg:justify-start items-center h-[92%] lg:h-full w-full lg:w-[78%] p-4 lg:py-0"
          initial={{ opacity: 0, x: 50 }}
          animate={{ opacity: 1, x: 0 }}
          transition={{ duration: 1, ease: "easeOut" }}
        >
          <div className="flex flex-col justify-between items-center w-full h-full rounded-lg px-4 md:px-8">
            <div className="flex flex-col justify-between items-start w-full h-full py-2 md:py-0 lg:py-5">
              {/* Title */}
              <div className="flex justify-center items-center w-full">
                <h1 className="text-xl md:text-2xl lg:text-3xl font-bold text-purple-950">
                  {title}
                </h1>
              </div>
              ...
              <div className="w-full h-[85%] flex flex-col justify-evenly gap-5 md:gap-0 py-4 mt-2 lg:mt-4 border-y-2 border-purple-900/20">
                <div className="flex flex-col gap-2 w-full">
                  <h2 className="text-lg md:text-xl lg:text-3xl font-semibold text-purple-950">
                    {currentClient.name}
                  </h2>
                ...
                >
                  {currentClient.projects?.map((project, index) => (
                    ...
                    >
                      <div className="w-full flex-shrink-0 min-w-[19rem] md:w-[22rem] md:h-[18rem] md:min-w-[20rem] md:max-w-[23rem] md:min-h-[18rem] lg:w-[28rem] lg:min-w-[28rem] lg:min-h-[23rem] p-4 flex flex-col gap-4 rounded-3xl text-purple-950 hover:shadow-xl hover:shadow-pink-200/20 hover:bg-gradient-to-b hover:from-purple-700/30 hover:to-yellow-100/80 bg-purple-950/20 transition">
                        <div>
                          <h3 className="text-sm md:text-lg lg:text-xl font-bold text-purple-950">
                            {project.client}
                          </h3>
                        </div>
                        <div className="w-full md:w-[90%] lg:w-full aspect-video">
                          <CldVideoPlayer
                            src={project.poster}
                        ...
                        <p className="text-xs md:text-xs lg:text-sm hidden md:block lg:block">
                          <b>Built using:</b>{" "}
                          {[
